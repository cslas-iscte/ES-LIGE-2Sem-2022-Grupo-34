    ...
    VF2State<V, E>
{
    ...
    public boolean isFeasiblePair()
    {
            ...
            && (newPred1 == newPred2))
        {
            ...
            if (DEBUG) {
                String cause = cause_refactoring(termOutPred1, termOutPred2, termInPred1, termInPred2, newPred1,
						newPred2);
				showLog("isFeasbilePair", abortmsg + ": " + cause);
            }
	...
	private String cause_refactoring(int termOutPred1, int termOutPred2, int termInPred1, int termInPred2, int newPred1,
			int newPred2) {
